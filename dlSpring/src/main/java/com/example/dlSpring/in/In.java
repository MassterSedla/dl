...
//
//        Switch switch1 = switchRepository.save(new Switch(4, "first", "1",  "D.2.021", 200, 200));
//        Switch switch2 = switchRepository.save(new Switch(14, "first", "1",  "D.3.044", 200, 200));
//        Switch switch3 = switchRepository.save(new Switch(13, "first", "2",  "D.1.007", 200, 200));
//        Switch switch4 = switchRepository.save(new Switch(16, "first", "3",  "D.1.027", 200, 200));
//        Switch switch5 = switchRepository.save(new Switch(16, "first", "2",  "C.3.056", 200, 200));
//        Switch switch6 = switchRepository.save(new Switch(11, "first", "2",  "C.1.033", 200, 200));
//        Switch switch7 = switchRepository.save(new Switch(16, "first", "1",  "C.1.034", 200, 200));
//        Switch switch8 = switchRepository.save(new Switch(19, "first", "3",  "B.4.025", 200, 200));
//        Switch switch9 = switchRepository.save(new Switch(17, "first", "2",  "B.3.041", 200, 200));
//        Switch switch0 = switchRepository.save(new Switch(12, "first", "3",  "B.1.013", 200, 200));
//
//
